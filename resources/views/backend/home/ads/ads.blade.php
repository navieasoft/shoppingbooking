        ...
        <div class="br-mainpanel">
            ...
            <div class="card">
                <div class="col-12">
                    ...
                    <div class="col-6">
                        <a href="/addAds" class="btn btn-primary" style="float: right;">Add Ads</a>
                    </div>
                </div>
<br>
<br>
                    ...
                    <table class="table" id="DataTable">
                        ...
                        @foreach ($ads as $key=>$s)
                            <tr>
                                ...
                                <td>
                                    <form action="editAds" method="post" style="float:left">
                                        @csrf
                                        <input type="hidden" name="adsId" value="{{ $s->id }}">
                                        <button class="btn btn-light"><i class="fa-duotone fa-edit"></i></button>
                                    </form>
                                    <form action="deleteAds" method="post" style="float:left">
                                        @csrf
                                        <input type="hidden" name="adsId" value="{{ $s->id }}">
