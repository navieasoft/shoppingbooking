        ...
        <div class="br-mainpanel">
            ...
            <div class="card">
                <div class="col-12">
                    ...
                    <div class="col-6">
                        <a href="/addBanner" class="btn btn-primary" style="float: right;">Add Banner</a>
                    </div>
                </div>
<br>
<br>
                    ...
                    <table class="table" id="DataTable">
                        ...
                        @foreach ($banner as $key=>$s)
                            <tr>
                                ...
                                <td>
                                    <form action="editBanner" method="post" style="float:left">
                                        @csrf
                                        <input type="hidden" name="bannerId" value="{{ $s->id }}">
                                        <button class="btn btn-light"><i class="fa-duotone fa-pen-to-square"></i></button>
                                    </form>
                                    <form action="deleteBanner" method="post" style="float:left">
                                        @csrf
                                        <input type="hidden" name="bannerId" value="{{ $s->id }}">
